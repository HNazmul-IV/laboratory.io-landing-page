      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6">
          <div bind:this={crazyCard} class="crazy-card text-center">
            <h1>
              <span class="text-green creazy">Crazy</span> <br />
              <span class="large-text text-white">5555</span> <br />
              <span class="text-green scientist">Scientists</span>
            </h1>
            <div bind:this={glowingBorder} class="glowing-border" />
          </div>
        </div>
