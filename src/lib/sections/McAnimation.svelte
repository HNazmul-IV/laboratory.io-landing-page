<script lang="ts">
    ...
    const COLOR_FACTOR = 0.2;
    onMount(() => {
        "use strict";
        var canvas = document.getElementById("mc_animation")! as HTMLCanvasElement;
        ...
        function splat(x, y, dx, dy, color) {
            ...
            gl.uniform3f(splatProgram.uniforms.color, color[0] * COLOR_FACTOR, color[1] * COLOR_FACTOR, color[2] * COLOR_FACTOR);
            blit(density.second[1]);
            density.swap();
        }
        ...
        canvas.addEventListener("mousemove", function (e) {
            ...
            pointers[0].dx = (e.offsetX - pointers[0].x) * 20.0;
            pointers[0].dy = (e.offsetY - pointers[0].y) * 20.0;
