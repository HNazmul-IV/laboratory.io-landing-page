...
<nav
  ...
  <div class="container-fluid more-horizontal-padding">
    <div class="">
      ...
      <a
        href="https://dapps.thelaboratory.io/"
        rel="noreferrer"
        target="_blank"
        class="lab-dapss-button"
    ...
    <div class="bar-svg">
      <svg
        ...
        <rect width="89" height="6" fill="#D9D9D9" />
        <rect y="13" width="89" height="6" fill="#D9D9D9" />
        <rect y="26" width="89" height="6" fill="#D9D9D9" />
      </svg>
    </div>
    <!-- <button
            bind:this="{barButton}"
          ...
          <a href="/#" class="social-icons">
            <svg
              ...
              <path
                ...
                fill="#B1FF05" />
              <path
                d="M24 13C24 13 18.722 17.594 16.6129 19.708C15.9372 20.385 15.8895 21.547 15.8895 21.547L14.7993 18.059L24 13Z"
                fill="#B1FF05" />
            </svg></a>
          <a href="/#" class="social-icons"
            ><svg
